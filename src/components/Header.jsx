...
const Header = () => {
  return (
    <header className="w-full px-7 py-4 flex justify-between items-center text-white font-[Poppins] [@media(min-width:1500px)]:sticky top-0 z-50">
      <a href="#" className="text-2xl font-semibold text-gray-300 hover:text-lime-400 transition duration-300">
        Yoyodevc
      </a>
      <div className="relative group">
        <a
          href="/Resume - John Fredrick Lim.pdf"
          download
